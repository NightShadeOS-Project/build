...
ifneq ($(NIGHTSHADE_BUILD),)
include vendor/nightshade/config/BoardConfigNightShade.mk
endif
...
ifneq ($(NIGHTSHADE_BUILD),)
ifneq ($(wildcard device/nightshade/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/nightshade/sepolicy/common/sepolicy.mk)
endif
endif
